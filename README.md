...
- **Duplicate paths with different methods** ([PR #1592](https://github.com/ogen-go/ogen/pull/1592)): Allow same path with different HTTP methods
- **x-ogen-name for parameters** ([PR #1594](https://github.com/ogen-go/ogen/pull/1594)): Custom naming for parameters
...
replace github.com/ogen-go/ogen => github.com/lanej/ogen v1.20.0
```
