...
import (
	...
	api "github.com/lanej/ogen/internal/integration/sample_api"
	"github.com/lanej/ogen/internal/integration/techempower"
	singleEndpoint "github.com/lanej/ogen/internal/integration/test_single_endpoint"
	"github.com/lanej/ogen/json"
)

// Ensure that convenient errors triggered on single endpoint.
//
// See https://github.com/lanej/ogen/issues/63.
var (
